...
Bei der Initialisierung werden alle $m$ Bits im Array auf $0$ gesetzt und $k$ Hash-Funktionen festgelegt. Je kleiner die gewünschte Fehlerrate sein soll, desto größer muss $m$ gewählt werden.
